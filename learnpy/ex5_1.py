...
for show_cdp_neighbors in (sw1_show_cdp_neighbors, r1_show_cdp_neighbors, r2_show_cdp_neighbors, r2_show_cdp_neighbors, r4_show_cdp_neighbors, r5_show_cdp_neighbors):
	show_cdp_neighbors = show_cdp_neighbors.split('\n')
	for neighbor_list in show_cdp_neighbors:
		neighbor_list = neighbor_list.split()
		print neighbor_list[4]